...
// Charts
const IngenieriaCharts = React.lazy(() => import('./views/components/charts/IngenieriaCharts'))
const HumanidadesCharts = React.lazy(() => import('./views/components/charts/HumanidadesCharts'))
const AdministracionCharts = React.lazy(() => import('./views/components/charts/AdministracionCharts'))
const PreparatoriaCharts = React.lazy(() => import('./views/components/charts/PreparatoriaCharts'))
...
const routes = [
  ...
  { path: '/cubiculos', name: 'Cubículos', component: Cubicles },
  { path: '/calendario', name: 'Calendario', component: Typography },
  { path: '/ingenieria', name: 'Ingeniería', component: IngenieriaCharts, exact: true },
  { path: '/humanidades', name: 'Humanidades', component: HumanidadesCharts, exact: true },
  { path: '/administracion', name: 'Administración', component: AdministracionCharts, exact: true },
  { path: '/preparatoria', name: 'Preparatoria', component: PreparatoriaCharts, exact: true },
//   { path: '/library', name: 'Library', component: Cubicles, exact: true },
//   { path: '/theme/typography', name: 'Typography', component: Typography },
//   { path: '/theme', name: 'Theme', component: Colors, exact: true },
//   { path: '/theme/colors', name: 'Colors', component: Colors },
//   { path: '/base', name: 'Base', component: Charts, exact: true },
...
//   { path: '/buttons', name: 'Buttons', component: Charts, exact: true },
//   { path: '/buttons/buttons', name: 'Buttons', component: Buttons },
//   { path: '/buttons/dropdowns', name: 'Dropdowns', component: Dropdowns },
//   { path: '/buttons/button-groups', name: 'Button Groups', component: ButtonGroups },
//   { path: '/charts', name: 'Charts', component: Charts },
//   { path: '/forms', name: 'Forms', component: Charts, exact: true },
