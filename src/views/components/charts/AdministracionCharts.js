      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <CChartPie
              data={{
                labels: ['LAE', 'LAM', 'LCPI', 'LDG', 'LINI', 'LLI', 'LNI'],
                datasets: [
                  {
                    data: [random(), random(), random(), random(), random(), random(), random()],
                    backgroundColor: ['#36A2EB', '#FFCE56', '#A51235', '#18456F', '#FFA123', '#AA18A3', '#FAA995'],
                    hoverBackgroundColor: ['#36A2EB', '#FFCE56', '#A51235', '#18456F', '#FFA123', '#AA18A3', '#FAA995'],
                  },
                ],
              }}
            />
